            ...
            <div class="grid grid-cols-2 gap-6 mb-8 bg-gray-50 p-4 rounded-lg border border-gray-200 print:bg-white">
                <div>
                    <table class="w-full text-sm">
                        ...
                        <tr><td class="py-1 text-gray-500">Status</td><td class="font-bold">: {{$penggajian->karyawan->status}}</td></tr>
                    </table>
                </div>
                <div>
                    <table class="w-full text-sm">
                        <tr><td class="py-1 text-gray-500 w-32">Departemen</td><td class="font-bold">: {{$penggajian->karyawan->departemen->nama ?? 'N/A'}}</td></tr>
                        <tr><td class="py-1 text-gray-500">Jabatan</td><td class="font-bold">: {{$penggajian->karyawan->jabatan->nama ?? 'N/A' }}</td></tr>
                        <tr><td class="py-1 text-gray-500">No. Rekening</td><td class="font-bold">: {{$penggajian->karyawan->no_rekening ?? 'N/A'}}</td></tr>
                    </table>
                </div>
            </div>
