 <div>
     ...
     @if (session()->has('info'))
         <div class="mb-4 p-4 bg-blue-100 border border-blue-400 text-blue-700 rounded-md shafow-md">
             {{ session('status')->get('info') }}
         </div>
     @endif
                     ...
                     @forelse ($karyawans as $karyawan)
                         <tr class="hover:bg-gray-50">
                             ...
                             <td class="px-6 py-4 text-sm text-gray-600">
                                 {{ $karyawan->departemen->nama ?? 'Tidak Ada' }}</td>
                             <td class="px-6 py-4 text-sm text-gray-600">{{ $karyawan->jabatan->nama ?? 'Tidak Ada' }}
                             </td>
                             ...
                             <td class="px-6 py-4 text-sm text-center font-medium flex justify-center gap-3">
                                 <button @click="showDetailModal({{ $karyawan->id }})"
                                 ...
                                 <button wire:click="delete ({{ $karyawan->id }}) "wire:confirm="Apakah Anda elu terserah lah mau ngapus"
         ...
         <div class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
             ...
             <div
                 ...
                 <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                     ...
                     <button wire:click="closeForModal" type="button"
                 ...
                 <form class="overflow-y-auto" wire:submit.prevent="store()">
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                             <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-sm">
                                 ...
                                 <div class="mb-3">
                                     <input type="text" wire:model="telepon"
                                         class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:ring-blue-500 focus:border-blue-500">
                                 </div>
                                 <div class="mb-3">
                                     <label class="block text-xs font-semibold text-gray-600 mb-1">Jenis kelamin</label>
                                     <select wire:model="jenis kelamin"
                             ...
                             <div class="bg-blue-50 p-4 rounded-lg border border-blue-100 shadow-sm">
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <input wire:model="jabatan_id" wire:change="updateGaji($event.target.value)"
                                         class="w-full px-3 py-2 border border-blue-200 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500">
                                 </div>
                                 <div class="mb-3">
                                     <label class="block text-xs font-semibold text-blue-800 mb-1">Status
                                         Karyawan</label>
                             ...
                             <div class="bg-green-50 p-4 rounded-lg border border-green-100 shadow-sm">
                                 ...
                                 <div class="mb-3">
                                     <label class="block text-xs font-semibold text-green-800 mb-1">Tunjangan
                                         Tetapi</label>
                     ...
                     <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-200">
                         <button type="button" wire:click="closeForModal()"
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                             ...
                             <div class="space-y-2 text-sm">
                                 ...
                                 <div class="flex justify-between"><span class="text-blue-600/70">Jabatan:</span>
                                     <span
                                         class="font-bold text-blue-900">{{ $karyawanDetail->jabatan->nama ?? '-' }}</span>
                                 </div>
                                 <div class="flex justify-between"><span class="text-blue-600/70">Tanggal
                                         Masuk:</span>
                                     <span
