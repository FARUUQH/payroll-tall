...
class KaryawanIndex extends Component
{
    ...
    {
        // ambil daftar jabatan yg HANYA milik departemen yang berkaitan
    ...
    public function store()
    {
        ...
        session()->flash('message', $this->karyawan_id ? 'Data Karyawan berhasil diperbarui.' : 'Data Karyawan berhasil dibuat.');
        $this->closeFormModal();
    }
